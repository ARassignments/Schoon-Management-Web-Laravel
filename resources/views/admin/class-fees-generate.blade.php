                ...
                <div class="card">
                        ...
                        <form method="POST" action="{{ route('store_class_voucher') }}">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 mb-3">
                                        ...
                                        <select name="section" id="section" class="form-control" required>
                                            ...
                                            <option value="{{ $section }}" {{ isset($selectedSection) && $selectedSection == $section ? 'selected' : '' }}>
                                                {{ $section }}
                                            </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-lg-12 mx-5 mb-4 mt-4">
                                        <div class="row">
                                            <div class="col-md-4 form-check d-flex align-items-center">
                                                <input type="checkbox" class="form-check-input me-2 fee-checkbox" id="admission-checkbox" name="fees[admission]" value="" data-fee="admission">
                                                <label class="form-check-label" for="admission-checkbox">Admission</label>
                                            </div>
                                            <div class="col-md-4 form-check d-flex align-items-center">
                                                <input type="checkbox" class="form-check-input me-2 fee-checkbox" id="tuition-checkbox" name="fees[tution]" value="" data-fee="tution">
                                                <label class="form-check-label" for="tuition-checkbox">Tuition</label>
                                            </div>
                                            <div class="col-md-4 form-check d-flex align-items-center">
                                                <input type="checkbox" class="form-check-input me-2 fee-checkbox" id="annual-checkbox" name="fees[annual]" value="" data-fee="annual">
                                                <label class="form-check-label" for="annual-checkbox">Annual</label>
                                            </div>
                                            <div class="col-md-4 form-check d-flex align-items-center">
                                                <input type="checkbox" class="form-check-input me-2 fee-checkbox" id="exam-fee-checkbox" name="fees[exam_fee]" value="" data-fee="exam_fee">
                                                <label class="form-check-label" for="exam-fee-checkbox">Exam
                                                    Fee</label>
                                            </div>
                                            <div class="col-md-4 form-check d-flex align-items-center">
                                                <input type="checkbox" class="form-check-input me-2 fee-checkbox" id="lab-charges-checkbox" name="fees[lab_charges]" value="" data-fee="lab_charges">
                                                <label class="form-check-label" for="lab-charges-checkbox">Lab
                                                    Charges</label>
                                            </div>
                                            <div class="col-md-4 form-check d-flex align-items-center">
                                                <input type="checkbox" class="form-check-input me-2 fee-checkbox" id="late-fee-checkbox" name="fees[late_fee]" value="" data-fee="late_fee">
                                                <label class="form-check-label" for="late-fee-checkbox">Late
                                                    Fee</label>
                                            </div>
                                            <div class="col-md-4 form-check d-flex align-items-center">
                                                <input type="checkbox" class="form-check-input me-2 fee-checkbox" id="pre-dues-checkbox" name="fees[pre_dues]" value="" data-fee="pre_dues">
                                                <label class="form-check-label" for="pre-dues-checkbox">PRE
                                                    DUES</label>
                                            </div>
                                            <div class="col-md-4 form-check d-flex align-items-center">
                                                <input type="checkbox" class="form-check-input me-2 fee-checkbox" id="id-card-checkbox" name="fees[id_card]" value="" data-fee="id_card">
                                                <label class="form-check-label" for="id-card-checkbox">ID
                                                    CARD</label>
                                            </div>
                                            <div class="col-md-4 form-check d-flex align-items-center">
                                                <input type="checkbox" class="form-check-input me-2 fee-checkbox" id="board-fee-checkbox" name="fees[board_fee]" value="" data-fee="board_fee">
                                                <label class="form-check-label" for="board-fee-checkbox">BOARD
                                                    FEE</label>
                                            </div>
                                            <div class="col-md-4 form-check d-flex align-items-center">
                                                <input type="checkbox" class="form-check-input me-2 fee-checkbox" id="stationary-checkbox" name="fees[stationary]" value="" data-fee="stationary">
                                                <label class="form-check-label" for="stationary-checkbox">STATIONARY</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 text-center mt-3">
                                        <a href="javascript:void(0);" class="btn btn-primary" onclick="printDiv('printableArea')"><i class="ri-printer-line"></i> Print</a>
                                    </div>
                                </div>
                            </div>
                        </form>
                    ...
                    <div class="container mt-5 shadow" style=" background-color: var(--tz-body-bg) ">
                        ...
                        <div id="printableArea">
                            ...
                            <div class="my-5 page" size="A4" style="width: auto; height:auto; overflow: hidden; background: white; display: block; position: relative;">
                                <div class="m-2 px-3 mt-4 border border-dark">
                                    <div class="pb-5 pt-3">
                                        <img src="{{ asset('assets/images/voucher-logo/voucherlogo.jpg') }}" width="100px">
                                    </div>
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-md-8">
                                                <p style="margin: 0; font-weight: 100; font-size: 14px; color: black;">
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <table class="table table-bordered border-dark" id="fees-table-{{ $admission->id }}" style="width: auto;">
                                                    <thead>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="text-center">
                                                            ...
                                                            <td class="lab_charges">{{ $fee->lab_charges }}</td>
