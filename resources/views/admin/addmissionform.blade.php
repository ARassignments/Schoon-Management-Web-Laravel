...
<div class="content-page mt-4">
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <button class="addbtn-container rounded row mb-3 "> <a href="{{ url('addadmissionform') }}" class="add-btn2 "><span class="spn2">Add Addmission Form</span></a>
            </button>
            <div class="row">
                <div class="col-xl-12 ">
                    <!-- Todo-->
                    <div class="">
                        <div class="card-body p-0">
                            ...
                            @if(session('success'))
                            <div id="successMessage" class="alert alert-success fade show mt-3 text-center" role="alert">
                                {{ session('success') }}
                            </div>
                            @endif
                            @if(session('successdelete'))
                            <div id="successMessage" class="alert alert-danger fade show mt-3 text-center" role="alert">
                                        ...
                                        <table class="table table-nowrap table-hover mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="text-center">
                                                    ...
                                                    <td>
                                                        <button type="button" class="btn our-color-1 rounded-2 shadow" data-bs-toggle="modal" data-bs-target="#statusModal{{ $addmission->id }}">
                                                            Change Status
                                                        </button>

                                                    </td>
                                                    <td>
                                                        <a href="{{ url('edit-admissionform', $addmission->id) }}" class="btn our-color-1 rounded-2 shadow">Edit</a>
                                                        <!-- Delete Button -->
                                                        <button type="button" class="btn btn-danger mx-2" data-bs-toggle="modal" data-bs-target="#deleteConfirmationModal{{ $addmission->id }}">Delete</button>

                                                        <!-- Delete Confirmation Modal -->
                                                        <div class="modal fade" id="deleteConfirmationModal{{ $addmission->id }}" tabindex="-1" aria-labelledby="deleteConfirmationLabel{{ $addmission->id }}" aria-hidden="true">
                                                            <div class="modal-dialog modal-dialog-centered">
                                                                <div class="modal-content">
                                                                    <div class="modal-header bg-danger text-white">
                                                                        <h5 class="modal-title" id="deleteConfirmationLabel{{ $addmission->id }}">Confirm Delete</h5>
                                                                        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                                                                    </div>
                                                                    <div class="modal-body ">
                                                                        <p class="fs-5">"Are you sure you want to delete the record for {{ $addmission->student_name }} {{ $addmission->father_name }}?"</p>
                                                                    </div>
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                                                                        <form method="get" action="{{ url('delete-addmissionform', $addmission->id) }}">
                                                                            @csrf
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    Swal.fire({
                        icon: 'success',
                        title: 'Success!',
                        text: 'Status for ' + studentName + ' ' + fatherName + ' updated successfully!',
