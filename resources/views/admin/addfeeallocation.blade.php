                                ...
                                <div class="row">
                                    <div class="mb-3 text-center">
                                        ...
                                        <div class="d-flex justify-content-center">
                                            <select name="class" id="artistDropdown" class="form-control mb-3"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="admission" class="form-control"
                                                placeholder="Admission" required pattern="\d+"
                                                title="Please enter a valid number">
                                        </div>

                                        <div class="mb-3">
                                            <label class="form-label">Tution</label>
                                            <input type="text" name="tution" class="form-control" placeholder="Tution"
                                                required pattern="\d+" title="Please enter a valid number">
                                        </div>

                                        <div class="mb-3">
                                            <label class="form-label">Annual</label>
                                            <input type="text" name="annual" class="form-control" placeholder="Annual"
                                                required pattern="\d+" title="Please enter a valid number">
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="exam_fee" class="form-control"
                                                placeholder="Exam Fee" required pattern="\d+"
                                                title="Please enter a valid number">
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="lab_charges" class="form-control"
                                                placeholder="Lab Charges" required pattern="\d+"
                                                title="Please enter a valid number">
                                        </div>
                                    </div> <!-- end col -->
                                    ...
                                    <div class="col-lg-6 mt-3 mt-lg-0">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="late_fee" class="form-control"
                                                placeholder="Late Fee" required pattern="\d+"
                                                title="Please enter a valid number">
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="pre_dues" class="form-control"
                                                placeholder="PRE DUES" required pattern="\d+"
                                                title="Please enter a valid number">
                                        </div>

                                        <div class="mb-3">
                                            <label class="form-label">ID CARD</label>
                                            <input type="text" name="id_card" class="form-control" placeholder="ID CARD"
                                                required pattern="\d+" title="Please enter a valid number">
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="board_fee" class="form-control"
                                                placeholder="BOARD FEE" required pattern="\d+"
                                                title="Please enter a valid number">
                                        </div>

                                        <div class="mb-3">
                                            <label class="form-label">STATIONARY</label>
                                            <input type="text" name="stationary" class="form-control"
                                                placeholder="STATIONARY" required pattern="\d+"
                                                title="Please enter a valid number">
                                        </div>
                                    </div>
                                    <!-- end col -->
