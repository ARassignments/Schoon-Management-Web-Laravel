                                            ...
                                            <div class="row">
                                                <div class="col-md-4 form-check d-flex align-items-center">
                                                    <input type="checkbox" class="form-check-input me-2 fee-checkbox"
                                                        id="admission-checkbox" name="fees[admission]" value="1"
                                                        data-fee="admission"
                                                ...
                                                <div class="col-md-4 form-check d-flex align-items-center">
                                                    <input type="checkbox" class="form-check-input me-2 fee-checkbox"
                                                        id="lab-charges-checkbox" name="fees[lab_charges]" value="1"
                                                ...
                                                <div class="col-md-4 form-check d-flex align-items-center">
                                                    <input type="checkbox" class="form-check-input me-2 fee-checkbox"
                                                        id="late-fee-checkbox" name="fees[late_fee]" value="1"
                                                ...
                                                <div class="col-md-4 form-check d-flex align-items-center">
                                                    <input type="checkbox" class="form-check-input me-2 fee-checkbox"
                                                        id="pre-dues-checkbox" name="fees[pre_dues]" value="1"
                                                ...
                                                <div class="col-md-4 form-check d-flex align-items-center">
                                                    <input type="checkbox" class="form-check-input me-2 fee-checkbox"
                                                        id="stationary-checkbox" name="fees[stationary]" value="1"
                                                        data-fee="stationary"
