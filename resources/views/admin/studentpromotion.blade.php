                    ...
                    <div class="">
                        <div class="card-body p-0">
                            ...
                            <form id="promoteForm">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 mt-3 mt-lg-0">
                                            ...
                                            <div class="text-center mt-5">
                                                ...
                                                <div class="d-flex justify-content-center">
                                                    <div class="form-group" style="width: 100%; max-width: 350px;">
                                                        <select name="to_class" class="form-control" style="
                                                          border-radius: 12px; 
                                                          border: 2px solid #0097B2; 
                                                          box-shadow: 0 2px 5px rgba(0, 0, 0, 0.1); 
                                                          font-size: 16px;">
                                            ...
                                            <div class="text-center ">
                                                <div class="d-flex justify-content-center">
                                                    <div class="form-group" style="width: 100%; max-width: 350px;">
                                                        <select name="to_section" class="form-control" style="
                                                                border-radius: 12px; 
                                                                border: 2px solid #0097B2; 
                                                                box-shadow: 0 2px 5px rgba(0, 0, 0, 0.1); 
                                                                font-size: 16px;">
                                ...
                                <div class="text-center">
                                    <button type="button" class="btn btn-primary our-color-1" id="promoteButton">Promote
                                        Students</button>
                                </div>
                            </form>
                                                ...
                                                @foreach ($add as $admission)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="form-check">
                                                                <input class="form-check-input studentCheckbox"
                                                                    type="checkbox" value="{{ $admission->gr_number }}"
            ...
            success: function (response) {
                ...
                if (students.length > 0) {
                    students.forEach(function (student) {
                        if (student.Status !== 'Pass Out' && student.Status !== 'Left Out') {
                            html += '<tr>' +
                                ...
                                '<td>' +
                                '<div class="form-check">' +
                                '<input class="form-check-input studentCheckbox" type="checkbox" value="' + student.id + '" id="flexCheckDefault">' +
                                '</div>' +
                                '</td>' +
                                '</tr>';
                        }
